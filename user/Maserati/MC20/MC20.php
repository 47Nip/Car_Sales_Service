...
<div class="car-images">
  <div>
    <img src="mc20-right-front-three-quarter.webp" alt="Description of the second image">
  </div>
  <div>
    <img src="download.jfif" alt="Description of the second image">
  </div>
</div>

 
<h1 class="car-name">Maserati MC20</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 3.65 crore</p>
  </div>
