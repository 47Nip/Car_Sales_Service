...
<div class="car-images">
  <div>
    <img src="Maserati-Quattroporte-Right-Side-54316.webp" alt="Description of the second image">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">RIGHT</p> -->
  </div>
  <div>
    <img src="Maserati-Quattroporte-Front-view-54314.webp" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 20px; font-family: 'Arial Black', sans-serif;">FRONT</p> -->
  </div>
  <div>
    <img src="Maserati-Quattroporte-Exterior-61019.webp" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT</p> -->
  </div>
</div>

 
<h1 class="car-name">Maserati Quattroporte</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 1.80 - 2.32 crore</p>
  </div>
  ...
  <div class="car-details-block">
    <h1>Milage</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">	8.2 - 9.4 km/l</p>
  </div>
