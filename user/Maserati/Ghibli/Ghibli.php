...
<div class="car-images">
  <div>
    <img src="Maserati-Ghibli-Exterior-123710.jpg" alt="Hyundai Creta Right Front Three Quarter">
  </div>
  <div>
    <img src="download (1).jfif" alt="Hyundai Creta Right Front Three Quarter">
  </div>
  <div>
    <img src="images.jfif" alt="Hyundai Creta Right Front Three Quarter">
  </div>
</div>

 
<h1 class="car-name">Maserati Ghibli</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 1.20 - 1.99 crore</p>
  </div>
    
  <div class="car-details-block">
    <h1>Fuel</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">Hybrid (Electric + Petrol), Petrol</p>
  </div>
    
  <div class="car-details-block">
    <h1>Milage</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">8 - 11.4 km/l</p>
  </div>
  ...
  <div class="warranty-safety__item">
    ...
    <span class="warranty-safety__text">Warranty: 4 Years or 80000 km</span>
  </div>
  <div class="warranty-safety__item">
