...
<div class="car-images">
  <div>
    <img src="3-series-gran-limousine-exterior-left-side-view.webp" alt="Description of the second image">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT</p> -->
  </div>
  <div>
    <img src="3-series-gran-limousine-exterior-left-side-view-3.webp" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 20px; font-family: 'Arial Black', sans-serif;">LEFT</p> -->
  </div>
  <div>
    <img src="3-series-gran-limousine-exterior-left-rear-three-quarter.webp" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT REAR</p> -->
  </div>
</div>

 
<h1 class="car-name">BMW 3 Series Gran Limousine</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 60.60 - 62.00 Lakh</p>
  </div>
  ...
  <div class="car-details-block">
    <h1>Milage</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">15.39 - 19.61 km/l</p>
  </div>
  ...
  <div class="warranty-safety__item">
    ...
    <span class="warranty-safety__text">Warranty: 3 Years or 40000 km</span>
  </div>
  <div class="warranty-safety__item">
