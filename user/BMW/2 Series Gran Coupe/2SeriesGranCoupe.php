...
<div class="car-images">
  <div>
    <img src="2-series-gran-coupe-exterior-left-side-view.webp" alt="Description of the second image">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT</p> -->
  </div>
  <div>
    <img src="2-series-gran-coupe-exterior-left-rear-three-quarter.webp" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 20px; font-family: 'Arial Black', sans-serif;">LEFT REAR</p> -->
  </div>
  <div>
    <img src="2-series-gran-coupe-exterior-left-front-three-quarter.webp" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT FRONT</p> -->
  </div>
</div>

 
<h1 class="car-name">BMW 2 Series Gran Coupe</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 43.90 - 46.90 Lakh</p>
  </div>
  ...
  <div class="car-details-block">
    <h1>Milage</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">14.82 - 18.64 km/l</p>
  </div>
