...
<div class="car-images">
  <div>
    <img src="m340i-exterior-rear-view.webp" alt="Description of the second image">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">REAR</p> -->
  </div>
  <div>
    <img src="m340i-exterior-left-side-view.webp" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 20px; font-family: 'Arial Black', sans-serif;">LEFT</p> -->
  </div>
  <div>
    <img src="m340i-exterior-left-rear-three-quarter.webp" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT REAR</p> -->
  </div>
</div>

 
<h1 class="car-name">BMW M340i</h1>
...
<div class="car-details">
  ...
  <div class="car-details-block">
    <h1>Milage</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">13.02 km/l</p>
  </div>
  ...
  <div class="warranty-safety__item">
    ...
    <span class="warranty-safety__text">Warranty: 3 Years or 40000 kmss</span>
  </div>
  <div class="warranty-safety__item">
