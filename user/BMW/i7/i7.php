...
<div class="car-images">
  <div>
    <img src="i7-exterior-left-side-view.webp" alt="Description of the second image">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT</p> -->
  </div>
  <div>
    <img src="i7-exterior-left-rear-three-quarter.webp" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 20px; font-family: 'Arial Black', sans-serif;">LEFT REAR</p> -->
  </div>
  <div>
    <img src="i7-exterior-left-front-three-quarter-3.webp" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT FRONT</p> -->
  </div>
</div>

 
<h1 class="car-name">BMW i7</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 2.13 - 2.50 crore</p>
  </div>
  ...
  <div class="car-details-block">
    ...
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">101.7 kWh <i class="fas fa-battery-full"></i></p>
  </div>
  <div class="car-details-block">
