...
<div class="car-images">
  <div>
    <img src="xuv700-exterior-left-side-view-2.webp" alt="Description of the second image">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT FRONT</p> -->
  </div>
  <div>
    <img src="xuv700-exterior-left-rear-three-quarter-2.webp" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 20px; font-family: 'Arial Black', sans-serif;">LEFT REAR</p> -->
  </div>
  <div>
    <img src="xuv700-exterior-left-front-three-quarter-2.webp" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT</p> -->
  </div>
</div>

 
<h1 class="car-name">Mahindra xuv700</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 13.99 - 26.99 Lakh</p>
  </div>
  ...
  <div class="car-details-block">
    <h1>Engine Size</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">1997 cc, 2184 cc</p>
  </div>
