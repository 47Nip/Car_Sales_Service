...
<html>
<head>
  <title>XUV300 TurboSport CAR DAETAILS</title>
...
<div class="car-images">
  <div>
    <img src="xuv300-sportz-exterior-front-view-2.webp" alt="Description of the second image">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">FRONT</p> -->
  </div>
  <div>
    <img src="mahindra-xuv300-turbo-sportz-right-rear-three-quarter11.webp" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 20px; font-family: 'Arial Black', sans-serif;">RIGHT REAR</p> -->
  </div>
  <div>
    <img src="mahindra-xuv300-turbo-sportz-right-front-three-quarter10.webp" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">RIGHT FRONT</p> -->
  </div>
</div>

 
<h1 class="car-name">Mahindra XUV300 TurboSport</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 9.31 - 13.16 Lakh</p>
  </div>
  ...
  <div class="car-details-block">
    <h1>Milage</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">12 - 14 km/l</p>
  </div>
  ...
  <div class="warranty-safety__item">
    ...
    <span class="warranty-safety__text">3 Years (Unlimited KMs)</span>
  </div>
  <div class="warranty-safety__item">
