...
<div class="car-images">
  <div>
    <img src="hector-plus-exterior-right-front-three-quarter-12.webp" alt="Description of the second image">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">RIGHT FRONT</p> -->
  </div>
  <div>
    <img src="hector-plus-exterior-right-front-three-quarter-3.webp" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 20px; font-family: 'Arial Black', sans-serif;">RIGHT FRONT</p> -->
  </div>
  <div>
    <img src="hector-plus-exterior-right-front-three-quarter-2.webp" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">RIGHT FRONT</p> -->
  </div>
</div>

 
<h1 class="car-name">MG </h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 17.75 - 22.88 Lakh</p>
  </div>
  ...
  <div class="car-details-block">
    <h1>Milage</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">11 - 14 km/l</p>
  </div>
  
  <div class="warranty-safety">
  <div class="warranty-safety__item">
    <i class="fas fa-shield-alt warranty-safety__icon"></i>
    <span class="warranty-safety__text">Warranty:5 Years (Unlimited KMs)</span>
  </div>
  <div class="warranty-safety__item">
