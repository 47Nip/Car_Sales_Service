...
<div class="car-images">
  <div>
    <img src="astor-exterior-left-side-view-2.webp" alt="Description of the second image">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT</p> -->
  </div>
  <div>
    <img src="astor-exterior-left-rear-three-quarter-2.webp" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 20px; font-family: 'Arial Black', sans-serif;">LEFT REAR</p> -->
  </div>
  <div>
    <img src="astor-exterior-left-front-three-quarter-2.webp" alt="Hyundai Creta Right Front Three Quarter">
...
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 9.98 - 17.90 Lakh</p>
  </div>
