...
<div class="container">
    ...
    <form action="submit_inquary.php" method="post" onsubmit="return validateInput()">
        <label for="name">Your Name:</label>
        <input type="text" id="name" name="name" required>
        <div id="validationMsg" style="display: none; color: red;">Please start with a non-numeric character.</div>
...
<script>
    ...
    if (/^\d/.test(input)) {
        // If it is numeric, show validation message
        document.getElementById("validationMsg").style.display = "block";
        return false; // Prevent form submission
    }
    // If not numeric, hide validation message
