...
<html>
<head>
  <title>TIAGO ALTROZ BS6 CAR DAETAILS</title>
...
<div class="car-images">
  <div>
    <img src="tiago-nrg-exterior-front-view.jpg" alt="Description of the second image">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">FRONT</p> -->
  </div>
  <div>
    <img src="tiago-nrg-exterior-left-front-three-quarter.jpg" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 20px; font-family: 'Arial Black', sans-serif;">LEFT FRONT</p> -->
  </div>
  <div>
    <img src="tiago-nrg-exterior-rear-view.jpg" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">REAR</p> -->
  </div>
</div>

 
<h1 class="car-name">Tata Tiago NRG</h1>
