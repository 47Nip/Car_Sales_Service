...
<div class="car-images">
  <div>
    <img src="kushaq-exterior-left-front-three-quarter-24.webp" alt="Description of the second image">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">FRONT</p> -->
  </div>
  <div>
    <img src="kushaq-exterior-left-front-three-quarter-25.webp" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 20px; font-family: 'Arial Black', sans-serif;">LEFT FRONT</p> -->
  </div>
  <div>
    <img src="kushaq-exterior-left-front-three-quarter-26.webp" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">FRONT</p> -->
  </div>
</div>

 
<h1 class="car-name">Skoda Kushaq</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 11.89 - 20.49 Lakh</p>
  </div>
  ...
  <div class="car-details-block">
    <h1>Milage</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">17.2 - 19.76 km/l</p>
  </div>
  ...
  <div class="warranty-safety__item">
    ...
    <span class="warranty-safety__text">Warranty: 4 Years or 100000 km</span>
  </div>
  <div class="warranty-safety__item">
