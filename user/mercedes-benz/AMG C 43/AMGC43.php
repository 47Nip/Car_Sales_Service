...
<div class="car-images">
  <div>
    <img src="amg-c-43-exterior-left-side-view.webp" alt="Description of the second image">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">RIGHT FRONT</p> -->
  </div>
  <div>
    <img src="amg-c-43-exterior-left-rear-three-quarter.webp" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 20px; font-family: 'Arial Black', sans-serif;">FRONT BUMPER</p> -->
  </div>
  <div>
    <img src="amg-c-43-exterior-left-front-three-quarter-2.webp" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT FRONT</p> -->
  </div>
</div>

 
<h1 class="car-name">Mercedes-Benz AMG C 43
</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 98.00 Lakh</p>
  </div>
