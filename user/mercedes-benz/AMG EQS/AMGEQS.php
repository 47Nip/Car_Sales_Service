...
<div class="car-images">
  <div>
    <img src="amg-eqs-exterior-left-side-view.webp" alt="Description of the second image">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT</p> -->
  </div>
  <div>
    <img src="amg-eqs-exterior-left-front-three-quarter-77.webp" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 20px; font-family: 'Arial Black', sans-serif;">LEFT FRONT</p> -->
  </div>
  <div>
    <img src="amg-eqs-exterior-left-front-three-quarter-74.webp" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT FRONT</p> -->
  </div>
</div>

 
<h1 class="car-name">Mercedes-Benz AMG EQS</h1>
...
<div class="car-details">
  ...
  <div class="car-details-block">
    ...
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">s107.8 kWh<i class="fas fa-battery-full"></i></p>
  </div>
  <div class="car-details-block">
    <h1>Battery Warranty</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">8 Years or 250000 km<i class="fas fa-battery-full"></i></p>
  </div>
