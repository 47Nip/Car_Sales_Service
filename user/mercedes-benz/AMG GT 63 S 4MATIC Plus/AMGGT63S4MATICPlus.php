...
<div class="car-images">
  <div>
    <img src="amg-gt-4-door-coupe-exterior-rear-view.webp" alt="Description of the second image">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">REAR</p> -->
  </div>
  <div>
    <img src="amg-gt-4-door-coupe-exterior-left-side-view.webp" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 20px; font-family: 'Arial Black', sans-serif;">LEFT</p> -->
  </div>
  <div>
    <img src="amg-gt-4-door-coupe-exterior-front-view.webp" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">FRONT</p> -->
  </div>
</div>

 
<h1 class="car-name">Mercedes-Benz AMG GT 63 S 4MATIC Plus</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 2.70 crore</p>
  </div>
  ...
  <div class="car-details-block">
    <h1>Milage</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">8.8 km/l</p>
  </div>
