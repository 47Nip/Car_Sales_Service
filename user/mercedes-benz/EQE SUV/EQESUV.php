...
<div class="car-images">
  <div>
    <img src="mercedes-benz-eqe-suv-left-side-view10.webp" alt="Description of the second image">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT</p> -->
  </div>
  <div>
    <img src="mercedes-benz-eqe-suv-front-view6.webp" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 20px; font-family: 'Arial Black', sans-serif;">FRONT</p> -->
  </div>
  <div>
    <img src="eqe-suv-exterior-left-front-three-quarter.webp" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT FRONT</p> -->
  </div>
</div>

 
<h1 class="car-name">Mercedes-Benz EQE SUV</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 1.39 crore</p>
  </div>
  ...
  <div class="car-details-block">
    ...
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">90.56 kWh<i class="fas fa-battery-full"></i></p>
  </div>
  <div class="car-details-block">
    <h1>Battery Warranty</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">10 Years or 2,50,000 km<i class="fas fa-battery-full"></i></p>
  </div>
