...
<div class="car-images">
  <div>
    <img src="rumion-exterior-right-front-three-quarter-5.webp" alt="Description of the second image">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">RIGHT FRONT</p> -->
  </div>
  <div>
    <img src="rumion-exterior-right-front-three-quarter-3.webp" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 20px; font-family: 'Arial Black', sans-serif;">RIGHT FRONT</p> -->
  </div>
  <div>
    <img src="rumion-exterior-grille.webp" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT</p> -->
  </div>
</div>

 
<h1 class="car-name">Toyota Rumion</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 10.44 - 13.73 Lakh</p>
  </div>
  ...
  <div class="car-details-block">
    <h1>Milage</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">	20.11 - 26.11 km/l</p>
  </div>
