...
<div class="car-images">
  <div>
    <img src="rs-q8-exterior-right-rear-three-quarter-2.webp" alt="Description of the second image">
    
  </div>
  <div>
    <img src="rs-q8-exterior-left-side-view-2.webp" alt="Hyundai Creta Right Front Three Quarter">
    
  </div>
  <div>
    <img src="rs-q8-exterior-left-front-three-quarter.webp" alt="Hyundai Creta Right Front Three Quarter">
    
  </div>
</div>

 
<h1 class="car-name">Audi RS Q8</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 2.22 crore</p>
  </div>
  ...
  <div class="car-details-block">
    <h1>Milage</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">8 km/l</p>
  </div>
