...
<div class="car-images">
  <div>
    <img src="q7-facelift-left-front-three-quarter.webp" alt="Description of the second image">
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT FRONT</p>
  </div>
  <div>
    <img src="q7-facelift-left-side-view-4.webp" alt="Hyundai Creta Right Front Three Quarter">
    <p style="color: black; font-size: 20px; font-family: 'Arial Black', sans-serif;">LEFT</p>
  </div>
  <div>
    <img src="rear-view.webp" alt="Hyundai Creta Right Front Three Quarter">
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">REAR</p>
  </div>
</div>

 
<h1 class="car-name">Audi Q7</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 86.92 - 94.45 Lakh</p>
  </div>
  ...
  <div class="car-details-block">
    <h1>Milage</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">11.2 km/l</p>
  </div>
