...
<div class="car-images">
  <div>
    <img src="q3-sportback-exterior-left-front-three-quarter-6.webp" alt="Description of the second image">
    
  </div>
  <div>
    <img src="q3-sportback-exterior-left-front-three-quarter-2.webp" alt="Hyundai Creta Right Front Three Quarter">
    
  </div>
  <div>
    <img src="q3-sportback-exterior-left-front-three-quarter.webp" alt="Hyundai Creta Right Front Three Quarter">
    
  </div>
</div>

 
<h1 class="car-name">Audi Q3 Sportback</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 54.22 Lakh</p>
  </div>
  ...
  <div class="warranty-safety__item">
    ...
    <span class="warranty-safety__text">Warranty: 3 Years or 50000 km</span>
  </div>
  <div class="warranty-safety__item">
