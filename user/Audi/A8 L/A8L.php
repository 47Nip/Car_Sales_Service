...
<div class="car-images">
  <div>
    <img src="a8-l-exterior-left-side-view.webp" alt="Description of the second image">
    
  </div>
  <div>
    <img src="a8-l-exterior-left-front-three-quarter-21.webp" alt="Hyundai Creta Right Front Three Quarter">
    
  </div>
  <div>
    <img src="a8-l-exterior-left-front-three-quarter-7.webp" alt="Hyundai Creta Right Front Three Quarter">
    
  </div>
</div>

 
<h1 class="car-name">Audi A8 L</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 1.34 - 1.63 crore</p>
  </div>
    
  <div class="car-details-block">
    <h1>Fuel</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">Mild Hybrid(Electric + Petrol)</p>
  </div>
