...
<div class="car-images">
  <div>
    <img src="q8-e-tron-sportback-right-front-three-quarter.webp" alt="Description of the second image">
   
  </div>
  <div>
    <img src="q8-sportback-e-tron-exterior-wheel.webp" alt="Hyundai Creta Right Front Three Quarter">
    
  </div>
  <div>
    <img src="q8-e-tron-sportback-exterior-left-front-three-quarter.webp" alt="Hyundai Creta Right Front Three Quarter">
    
  </div>
</div>

 
<h1 class="car-name">Audi Q8 Sportback e-tron</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 1.19 - 1.32 crore</p>
  </div>
  ...
  <div class="car-details-block">
    ...
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">No Years or No km<i class="fas fa-battery-full"></i></p>
  </div>
