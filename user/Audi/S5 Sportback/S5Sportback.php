...
<div class="car-images">
  <div>
    <img src="s5-sportback-exterior-left-front-three-quarter.webp" alt="Description of the second image">

  </div>
  <div>
    <img src="s5-sportback-exterior-right-rear-three-quarter.webp" alt="Hyundai Creta Right Front Three Quarter">
   
  </div>
  <div>
    <img src="s5-sportback-exterior-right-front-three-quarter.webp" alt="Hyundai Creta Right Front Three Quarter">
    
  </div>
</div>

 
<h1 class="car-name">Audi S5 Sportback</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 75.80 Lakh</p>
  </div>
  ...
  <div class="car-details-block">
    <h1>Milage</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">10.6 km/l</p>
  </div>
