...
<div class="car-images">
  <div>
    <img src="q8-e-tron-exterior-rear-view.webp" alt="Description of the second image">
    
  </div>
  <div>
    <img src="q8-e-tron-exterior-left-rear-three-quarter.webp" alt="Hyundai Creta Right Front Three Quarter">
    
  </div>
  <div>
    <img src="q8-e-tron-exterior-left-front-three-quarter.webp" alt="Hyundai Creta Right Front Three Quarter">
    
  </div>
</div>

 
<h1 class="car-name">Audi Q8 e-tron</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 1.15 - 1.27 crore</p>
  </div>
