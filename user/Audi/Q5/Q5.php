...
<div class="car-images">
  <div>
    <img src="q5-facelift-exterior-left-front-three-quarter.webp" alt="Description of the second image">
   
  </div>
  <div>
    <img src="q5-facelift-exterior-left-rear-three-quarter.webp" alt="Hyundai Creta Right Front Three Quarter">
    
  </div>
  <div>
    <img src="q5-facelift-exterior-left-side-view.webp" alt="Hyundai Creta Right Front Three Quarter">
    
  </div>
</div>

 
<h1 class="car-name">Audi Q5</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 65.18 - 70.45 Lakh</p>
  </div>
