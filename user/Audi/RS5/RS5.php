...
<div class="car-images">
  <div>
    <img src="rs5-exterior-left-front-three-quarter.webp" alt="Description of the second image">
    
  </div>
  <div>
    <img src="rs5-exterior-left-rear-three-quarter.webp" alt="Hyundai Creta Right Front Three Quarter">
    
  </div>
  <div>
    <img src="rs5-exterior-left-side-view.webp" alt="Hyundai Creta Right Front Three Quarter">
    
  </div>
</div>

 
<h1 class="car-name">Audi RS5</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 1.13 crore</p>
  </div>
  ...
  <div class="car-details-block">
    <h1>Milage</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">10.8 km/l</p>
  </div>
