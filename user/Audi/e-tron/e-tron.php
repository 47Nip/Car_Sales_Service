...
<div class="car-images">
  <div>
    <img src="e-tron-exterior-left-front-three-quarter.webp" alt="Description of the second image">
    
  </div>
  <div>
    <img src="e-tron-exterior-left-rear-three-quarter.webp" alt="Hyundai Creta Right Front Three Quarter">
    
  </div>
  <div>
    <img src="e-tron-exterior-left-side-view.webp" alt="Hyundai Creta Right Front Three Quarter">
    
  </div>
</div>

 
<h1 class="car-name">Audi e-tron</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 1.02 - 1.25 crore</p>
  </div>
  ...
  <div class="car-details-block">
    ...
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">71 kWh <i class="fas fa-battery-full"></i></p>
  </div>
  <div class="car-details-block">
