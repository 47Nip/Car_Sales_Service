...
<div class="car-images">
  <div>
    <img src="a6-exterior-right-front-three-quarter-2.webp" alt="Description of the second image">

  </div>
  <div>
    <img src="a6-exterior-left-front-three-quarter-3.webp" alt="Hyundai Creta Right Front Three Quarter">
   
  </div>
  <div>
    <img src="Audi-New-A6-Exterior-169814.webp" alt="Hyundai Creta Right Front Three Quarter">
   
  </div>
</div>

 
<h1 class="car-name">Audi A6</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 64.07 - 70.41 Lakh</p>
  </div>
  ...
  <div class="car-details-block">
    <h1>Milage</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">14 km/l</p>
  </div>
