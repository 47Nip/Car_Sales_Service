...
<div class="car-images">
  <div>
    <img src="e-tron-gt-exterior-rear-view.webp" alt="Description of the second image">
    
  </div>
  <div>
    <img src="audi-e-tron-gt-right-front-three-quarter0.webp" alt="Hyundai Creta Right Front Three Quarter">
   
  </div>
  <div>
    <img src="e-tron-gt-exterior-front-view.webp" alt="Hyundai Creta Right Front Three Quarter">
    
  </div>
</div>

 
<h1 class="car-name">Audi e-tron GT</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 1.72 - 1.95 crore</p>
  </div>
  ...
  <div class="car-details-block">
    ...
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">93.4 kWh <i class="fas fa-battery-full"></i></p>
  </div>
  <div class="car-details-block">
