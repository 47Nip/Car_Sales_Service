...
<div class="car-images">
  <div>
    <img src="cooper-se-left-side-view.webp" alt="Description of the second image">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT</p> -->
  </div>
  <div>
    <img src="cooper-se-left-front-three-quarter.webp" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 20px; font-family: 'Arial Black', sans-serif;">LEFT FRONT</p> -->
  </div>
  <div>
    <img src="cooper-se-exterior-left-front-three-quarter-2.webp" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT FRONT</p> -->
  </div>
</div>

 
<h1 class="car-name">Mini Cooper SE</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 53.00 - 55.00 Lakh</p>
  </div>
  ...
  <div class="car-details-block">
    ...
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">32.6 kWh <i class="fas fa-battery-full"></i></p>
  </div>
  <div class="car-details-block">
    <h1>Battery Warranty</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">8 Years or 100000 km<i class="fas fa-battery-full"></i></p>
  </div>
  ...
  <div class="warranty-safety__item">
    ...
    <span class="warranty-safety__text">Safety Rating: 	Not Tested star NCAP Rating </span>
  </div>
</div>
</div>
<br><br>
