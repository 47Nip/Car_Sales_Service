...
<div class="car-images">
  <div>
    <img src="download2354.jpg" alt="Description of the second image">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">RIGTH</p> -->
  </div>
  <div>
    <img src="front-left-side-47.jpg" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 20px; font-family: 'Arial Black', sans-serif;">LEFT</p> -->
  </div>
  <div>
    <img src="download.jfif" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">RIGHT FRONT</p> -->
  </div>
</div>
 
<h1 class="car-name">Maruti Suzuki Dzire</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 4.26 - 6.11 Lakh</p>
  </div>
  ...
  <div class="car-details-block">
    <h1>Mileage</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">24.12 - 32.73 km/l</p>
  </div>
...
<div class="warranty-safety">
  ...
  <div class="warranty-safety__item">
    ...
    <span class="warranty-safety__text">Safety Rating: 0 Star (Global NCAP)</span>
  </div>
</div>
<br><br>
