...
<div class="car-images">
  <div>
    <img src="jimny-exterior-left-front-three-quarter-2.jpg" alt="Description of the second image">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT FRONT</p> -->
  </div>
  <div>
    <img src="jimny-exterior-left-rear-three-quarter.jpg" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 20px; font-family: 'Arial Black', sans-serif;">LEFT REAR</p> -->
  </div>
  <div>
    <img src="jimny-exterior-left-side-view.jpg" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT</p> -->
  </div>
</div>
 
<h1 class="car-name">Maruti Suzuki Jimny</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 12.74 - 15.00 Lakh</p>
  </div>
  ...
  <div class="car-details-block">
    <h1>Mileage</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">16.39 - 16.94 km/l</p>
  </div>
