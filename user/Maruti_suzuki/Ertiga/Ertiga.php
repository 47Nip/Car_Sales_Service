...
<html>
<head>
  <title>ERTIGA CAR DETAILS</title>
...
<div class="car-images">
  <div>
    <img src="ertiga-exterior-left-front-three-quarter.webp" alt="Description of the second image">
  </div>
  <div>
    <img src="ertiga-exterior-left-rear-three-quarter.webp" alt="Hyundai Creta Right Front Three Quarter">
  </div>
  <div>
    <img src="ertiga-exterior-left-side-view.webp" alt="Hyundai Creta Right Front Three Quarter">
  </div>
</div>
 
<h1 class="car-name">Maruti Suzuki Ertiga</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 8.69 - 13.03 Lakh</p>
  </div>
  ...
  <div class="car-details-block">
    <h1>Mileage</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">20.3 - 26.11 km/l</p>
  </div>
