...
<html>
<head>
  <title>ALTO K10 CAR DETAILS</title>
...
<div class="car-images">
  <div>
    <img src="alto-k10-exterior-right-front-three-quarter-57.jpg" alt="Description of the second image">  
  </div>
  <div>
    <img src="alto-k10-exterior-right-rear-three-quarter.jpg" alt="Hyundai Creta Right Front Three Quarter"> 
  </div>
  <div>
    <img src="alto-k10-exterior-right-side-view.jpg" alt="Hyundai Creta Right Front Three Quarter">
  </div>
  
</div>
 
<h1 class="car-name">Maruti Suzuki Alto K10</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 3.99 - 5.96 Lakh</p>
  </div>
  ...
  <div class="car-details-block">
    <h1>Mileage</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">24.39 - 33.85 km/l</p>
  </div>
