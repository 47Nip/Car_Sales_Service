...
<div class="car-images">
  <div>
    <img src="fronx-exterior-left-rear-three-quarter-2.webp" alt="Description of the second image">
  </div>
  <div>
    <img src="fronx-exterior-left-front-three-quarter-2.webp" alt="Hyundai Creta Right Front Three Quarter">
  </div>
  <div>
    <img src="fronx-exterior-rear-view-2.webp" alt="Hyundai Creta Right Front Three Quarter">
    
  </div>
</div>
 
<h1 class="car-name">Maruti Suzuki Fronx</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 7.51 - 13.03 Lakh</p>
  </div>
  ...
  <div class="car-details-block">
    <h1>Mileage</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">20.01 - 28.51 km/l</p>
  </div>
