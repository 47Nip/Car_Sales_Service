...
<html>
<head>
  <title>KONA ELECTRIC CAR DAETAILS</title>
...
<div class="car-images">
  <div>
    <img src="Hyundai-Kona-EV-Front-view-159137.jpg" alt="Description of the second image">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">FRONT</p> -->
  </div>
  <div>
    <img src="Hyundai-Kona-EV-Rear-view-159136.jpg" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 20px; font-family: 'Arial Black', sans-serif;">REAR</p> -->
  </div>
  <div>
    <img src="Hyundai-Kona-EV-Rear-view-159138.jpg" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">REAR</p> -->
  </div>
</div>

 
<h1 class="car-name">Hyundai Kona Electric</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 23.84 - 24.03 Lakh</p>
  </div>
  ...
  <div class="car-details-block">
    <h1>Milage</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">10 - 15.5 km/l</p>
  </div>
  ...
  <div class="car-details-block">
    ...
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">39.2 kWh <i class="fas fa-battery-full"></i></p>
  </div>
  <div class="car-details-block">
    <h1>Charging time at home</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">6.1 hours @ 230V <i class="fas fa-battery-full"></i></p>
  </div>
  <div class="warranty-safety">
  <div class="warranty-safety__item">
    <i class="fas fa-shield-alt warranty-safety__icon"></i>
    <span class="warranty-safety__text">Warranty:3 Years (Unlimited KMs)</span>
  </div>
  <div class="warranty-safety__item">
