...
<html>
<head>
  <title>IONIQ-5 CAR DAETAILS</title>
...
<div class="car-images">
  <div>
    <img src="ioniq-5-exterior-left-front-three-quarter.jpg" alt="Description of the second image">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT FRONT</p> -->
  </div>
  <div>
    <img src="ioniq-5-exterior-left-rear-three-quarter.jpg" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 20px; font-family: 'Arial Black', sans-serif;">LEFT REAR</p> -->
  </div>
  <div>
    <img src="ioniq-5-exterior-left-side-view.jpg" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT</p> -->
  </div>
</div>

 
<h1 class="car-name">Hyundai Ioniq-5</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 46.05 Lakh</p>
  </div>
  ...
  <div class="car-details-block">
    <h1>Milage</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">12.95 - 15.38 kml</p>
  </div>
  ...
  <div class="car-details-block">
    ...
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">72.6 kWh <i class="fas fa-battery-full"></i></p>
  </div>
  <div class="car-details-block">
  ...
  <div class="warranty-safety__item">
    ...
    <span class="warranty-safety__text">Warranty: 3 Years or Unlimted km</span>
  </div>
  <div class="warranty-safety__item">
