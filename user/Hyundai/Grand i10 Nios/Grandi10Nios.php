...
<html>
<head>
  <title>GRAND I10 NIOS CAR DAETAILS</title>
...
<div class="car-images">
  <div>
    <img src="grand-i10-nios-exterior-left-front-three-quarter.jpg" alt="Description of the second image">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">REAR VIEW</p> -->
  </div>
  <div>
    <img src="grand-i10-nios-exterior-left-rear-three-quarter.jpg" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 20px; font-family: 'Arial Black', sans-serif;">RIGHT FRONT VIEW</p> -->
  </div>
  <div>
    <img src="grand-i10-nios-exterior-rear-view.jpg" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">RIGHT REAR VIEW</p> -->
  </div>
</div>

 
<h1 class="car-name">Hyundai Grand i10 Nios</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 5.92 - 8.56 Lakh</p>
  </div>
  ...
  <div class="car-details-block">
    <h1>Milage</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">12 - 16 km/l</p>
  </div>
