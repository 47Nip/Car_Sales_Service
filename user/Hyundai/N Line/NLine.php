...
<html>
<head>
  <title> N LINE CAR DAETAILS</title>
...
<div class="car-images">
  <div>
    <img src="i20-n-line-exterior-right-side-view.jpg" alt="Description of the second image">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">RIGHT</p> -->
  </div>
  <div>
    <img src="i20-n-line-exterior-right-front-three-quarter-8.jpg" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 20px; font-family: 'Arial Black', sans-serif;">RIGHT FRONT</p> -->
  </div>
  <div>
    <img src="i20-n-line-exterior-left-front-three-quarter.jpg" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT</p> -->
  </div>
</div>

 
<h1 class="car-name">Hyundai i20 N Line</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 9.99 - 12.52 Lakh</p>
  </div>
  ...
  <div class="car-details-block">
    <h1>Milage</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;"> 19.7 - 20.7 km/l </p>
  </div>
