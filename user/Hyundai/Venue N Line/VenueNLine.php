...
<html>
<head>
  <title>VENUE N LINE CAR DAETAILS</title>
...
<div class="car-images">
  <div>
    <img src="venue-n-line-exterior-left-front-three-quarter.jpg" alt="Description of the second image">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT FRONT</p> -->
  </div>
  <div>
    <img src="venue-n-line-exterior-left-rear-three-quarter.jpg" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 20px; font-family: 'Arial Black', sans-serif;">LEFT REAR</p> -->
  </div>
  <div>
    <img src="venue-n-line-exterior-left-side-view.jpg" alt="Hyundai Creta Right Front Three Quarter">
    <!-- <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT</p> -->
  </div>
</div>

 
<h1 class="car-name">Hyundai Venue N Line</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 12.08 - 13.90 Lakh</p>
  </div>
