...
<div class="car-images">
  <div>
    <img src="ev6-exterior-left-side-view-2.webp" alt="Description of the second image">
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT</p>
  </div>
  <div>
    <img src="ev6-exterior-left-rear-three-quarter-2.webp" alt="Hyundai Creta Right Front Three Quarter">
    <p style="color: black; font-size: 20px; font-family: 'Arial Black', sans-serif;">LEFT</p>
  </div>
  <div>
    <img src="ev6-exterior-left-front-three-quarter-10.webp" alt="Hyundai Creta Right Front Three Quarter">
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT FRONT</p>
  </div>
</div>

 
<h1 class="car-name">Kia EV6</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 60.95 - 65.95 Lakh</p>
  </div>
  ...
  <div class="car-details-block">
    ...
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">77.4 kWh<i class="fas fa-battery-full"></i></p>
  </div>
  <div class="car-details-block">
