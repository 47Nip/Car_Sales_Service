...
<div class="car-images">
  <div>
    <img src="seltos-exterior-left-side-view.webp" alt="Description of the second image">
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT</p>
  </div>
  <div>
    <img src="seltos-exterior-left-rear-three-quarter.webp" alt="Hyundai Creta Right Front Three Quarter">
    <p style="color: black; font-size: 20px; font-family: 'Arial Black', sans-serif;">LEFT</p>
  </div>
  <div>
    <img src="seltos-exterior-left-front-three-quarter.webp" alt="Hyundai Creta Right Front Three Quarter">
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT FRONT</p>
  </div>
</div>

 
<h1 class="car-name">Kia Seltos</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 10.90 - 20.30 Lakh</p>
  </div>
  ...
  <div class="car-details-block">
    <h1>Milage</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">17 - 20.7 km/l</p>
  </div>
