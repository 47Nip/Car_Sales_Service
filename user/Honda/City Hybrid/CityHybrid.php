...
<html>
<head>
  <title>CITY HYBRID CAR DAETAILS</title>
...
<div class="car-images">
  <div>
    <img src="city-hybrid-ehev-exterior-closed-boot-trunk.jpg" alt="Description of the second image">
   
  </div>
  <div>
    <img src="download875.jpg" alt="Hyundai Creta Right Front Three Quarter">
    
  </div>
  <div>
    <img src="download6546.jpg" alt="Hyundai Creta Right Front Three Quarter">
    
  </div>
</div>

 
<h1 class="car-name">Honda City Hybrid eHEV</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 18.93 - 20.43 Lakh</p>
  </div>
