...
<html>
<head>
  <title>ELEVATE CAR DAETAILS</title>
...
<div class="car-images">
  <div>
    <img src="elevate-exterior-left-front-three-quarter-23.JPG" alt="Description of the second image">
    
  </div>
  <div>
    <img src="elevate-exterior-left-front-three-quarter-10.jpg" alt="Hyundai Creta Right Front Three Quarter">
    
  </div>
  <div>
    <img src="elevate-exterior-left-rear-three-quarter.jpg" alt="Hyundai Creta Right Front Three Quarter">
    
  </div>
</div>

 
<h1 class="car-name">Honda Elevate</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 11.56 - 16.42 Lakh</p>
  </div>
  ...
  <div class="car-details-block">
    <h1>Milage</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">15.31 - 16.92 km/l</p>
  </div>
