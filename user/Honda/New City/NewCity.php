...
<html>
<head>
  <title>NEW CITY CAR DAETAILS</title>
...
<div class="car-images">
  <div>
    <img src="city-exterior-left-front-three-quarter.jpg" alt="Description of the second image">
    
  </div>
  <div>
    <img src="city-exterior-left-rear-three-quarter.jpg" alt="Hyundai Creta Right Front Three Quarter">
   
  </div>
  <div>
    <img src="city-exterior-left-side-view.jpg" alt="Hyundai Creta Right Front Three Quarter">
    
  </div>
</div>

 
<h1 class="car-name">Honda New City</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 11.74 - 16.22 Lakh</p>
  </div>
  ...
  <div class="car-details-block">
    <h1>Milage</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">17.8 - 18.4 km/l</p>
  </div>
