...
<html>
<head>
  <title>AMAZE CAR DAETAILS</title>
...
<div class="car-images">
  <div>
    <img src="amaze-facelift-exterior-left-front-three-quarter-2.jpg" alt="Description of the second image">
    
  </div>
  <div>
    <img src="amaze-facelift-exterior-left-rear-three-quarter.jpg" alt="Hyundai Creta Right Front Three Quarter">
    
  </div>
  <div>
    <img src="amaze-facelift-exterior-left-side-view.jpg" alt="Hyundai Creta Right Front Three Quarter">
   
  </div>
</div>

 
<h1 class="car-name">Honda Amaze</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 7.18 - 9.94 Lakh</p>
  </div>
  ...
  <div class="car-details-block">
    <h1>Milage</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">18.3 - 18.6 km/l</p>
  </div>
