...
<div class="car-images">
  <div>
    <img src="wrangler-exterior-left-front-three-quarter.webp" alt="Description of the second image">
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT FRONT</p>
  </div>
  <div>
    <img src="wrangler-exterior-left-rear-three-quarter.webp" alt="Hyundai Creta Right Front Three Quarter">
    <p style="color: black; font-size: 20px; font-family: 'Arial Black', sans-serif;">LEFT REAR</p>
  </div>
  <div>
    <img src="wrangler-exterior-left-side-view.webp" alt="Hyundai Creta Right Front Three Quarter">
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT</p>
  </div>
</div>

 
<h1 class="car-name">Jeep Wrangler</h1>
  
<div class="car-details">
  <div class="car-details-block">
    <h1>Price</h1>
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">₹ 62.64 - 66.64 Lakh</p>
  </div>
  ...
  <div class="warranty-safety__item">
    ...
    <span class="warranty-safety__text">Safety Rating: 1 Star (Euro NCAP)</span>
  </div>
</div>
</div>
<br><br>
