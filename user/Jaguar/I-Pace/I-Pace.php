...
<div class="car-images">
  <div>
    <img src="http://localhost/Jaguar/I-Pace/i-pace-exterior-left-front-three-quarter.webp" alt="Description of the second image">
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">LEFT FRONT</p>
  </div>
  <div>
    <img src="http://localhost/Jaguar/I-Pace/Jaguar-IPace-Exterior-154636.webp" alt="Hyundai Creta Right Front Three Quarter">
    <p style="color: black; font-size: 20px; font-family: 'Arial Black', sans-serif;">RIGHT FRONT</p>
  </div>
  <div>
    <img src="http://localhost/Jaguar/I-Pace/Jaguar-IPace-Exterior-154635.webp" alt="Hyundai Creta Right Front Three Quarter">
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">RIGHT FRONT</p>
  </div>
</div>

 
<h1 class="car-name">Jaguar I-Pace</h1>
...
<div class="car-details">
  ...
  <div class="car-details-block">
    ...
    <p style="color: black; font-size: 18px; font-family: 'Times New Roman', serif;">90 kWh <i class="fas fa-battery-full"></i></p>
  </div>
  <div class="car-details-block">
